...
silent only
silent tabonly
cd ~/Documents/Programming/C++Programs/PopulationPrediction
...
badd +1 CSVFile.cpp
badd +23 CSVFile.hpp
badd +1 Simulation.cpp
badd +19 Simulation.hpp
badd +1 Grass.cpp
argglobal
silent! argdel *
$argadd main.cpp
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 19 - ((17 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19
...
wincmd w
argglobal
if bufexists('Simulation.cpp') | buffer Simulation.cpp | else | edit Simulation.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 68 - ((46 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 11 - ((5 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
11
